...
<script setup>
    ...
    const fetch = async () => {
        ...
        try
        {
            let response = await axios.get(route('admin.docs.search', {
    ...
    const storeDocument = () => {
        documentForm.post(route('admin.docs.store'), {
            forceFormData: true,
    ...
    const updateDocument = () => {
        Inertia.post(route('admin.docs.update', documentForm.id), {
            _method: 'put',
            ...documentForm,
        }, {
            forceFormData: true,
    ...
    const deleteDocument = () => {
        documentForm.delete(route('admin.docs.delete', documentForm.id), {
            onSuccess() {
                closeUploadDocumentPopup()
