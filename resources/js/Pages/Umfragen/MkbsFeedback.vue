<template>
    <TextSubLayout title="MKBS Kundenzufriedenheit" has-small-limiter>
        ...
        <form @submit="submit()">
            ...
            <div class="group">
                <ScaleInput name="s1" :options="sentimentOptions" v-model="form.generalSentiment"/>
            </div>
            <p>&nbsp;</p>
            ...
            <div class="group">
                <h5>Angebot</h5>
                <ScaleInput name="s2" :options="sentimentOptions" v-model="form.metricPortfolioSentiment"/>
                <h5>Qualität</h5>
                <ScaleInput name="s3" :options="sentimentOptions" v-model="form.metricQualitySentiment"/>
                <h5>Preis-Leistung</h5>
                <ScaleInput name="s4" :options="sentimentOptions" v-model="form.metricPriceSentiment"/>
                <h5>Design</h5>
                <ScaleInput name="s5" :options="sentimentOptions" v-model="form.metricDesignSentiment"/>
            </div>
            <p>&nbsp;</p>
            ...
            <div class="group">
                <h5>Print</h5>
                <ScaleInput name="s6" :options="sentimentOptions" v-model="form.departmentPrintSentiment"/>
                <h5>Website/Shop</h5>
                <ScaleInput name="s7" :options="sentimentOptions" v-model="form.departmentWebsiteSentiment"/>
                <h5>Social Media</h5>
                <ScaleInput name="s8" :options="sentimentOptions" v-model="form.departmentSocialMediaSentiment"/>
            </div>
            <p>&nbsp;</p>
            ...
            <div class="group">
                ...
                <ScaleInput name="s9" :options="sentimentOptions" v-model="form.softskillsPolitenessSentiment"/>
                <h5>Beratung</h5>
                <ScaleInput name="s10" :options="sentimentOptions" v-model="form.softskillsConsultationSentiment"/>
                <h5>Professionalität</h5>
                <ScaleInput name="s11" :options="sentimentOptions" v-model="form.softskillsProfessionalismSentiment"/>
                <h5>Problemlösung</h5>
                <ScaleInput name="s12" :options="sentimentOptions" v-model="form.softskillsProblemSolvingSentiment"/>
                <h5>Gesamteindruck</h5>
                <ScaleInput name="s13" :options="sentimentOptions" v-model="form.softskillsOverallSentiment"/>
            </div>
            <p>&nbsp;</p>
            ...
            <div class="group">
                <ScaleInput name="s14" :options="booleanOptions" v-model="form.wantsWorkshops"/>
                <mui-input type="textarea" class="input" v-if="form.wantsWorkshops" v-model="form.workshops" border placeholder="In welcher Form?"/>
            </div>
            <p>&nbsp;</p>
    
            <h4>Würden Sie sich von uns öfter Angebote/Aktionen wünschen?</h4>
            <div class="group">
                <ScaleInput name="s15" :options="booleanOptions" v-model="form.wantsOffers"/>
                <mui-input type="textarea" class="input" v-if="form.wantsOffers" v-model="form.offers" border placeholder="In welcher Form? (z. B. Rabatte, Angebotspakete, Gewinnspiele, ...)"/>
            </div>
            <p>&nbsp;</p>
            ...
            <div class="group">
                <div class="flex v-center gap-1">
                    ...
                    <ScaleInput name="s16" :options="booleanOptions" v-model="form.serviceSocialMediaAcknowledgement"/>
                </div>
                <div class="flex v-center gap-1">
                    <b class="flex-1">Erstellung von Webseiten / Onlineshops</b>
                    <ScaleInput name="s17" :options="booleanOptions" v-model="form.serviceWebsiteAcknowledgement"/>
                </div>
                <div class="flex v-center gap-1">
                    <b class="flex-1">Recruiting (Kampagnen zur Mitarbeitergewinnung)</b>
                    <ScaleInput name="s18" :options="booleanOptions" v-model="form.serviceRecruitingAcknowledgement"/>
                </div>
                <div class="flex v-center gap-1">
                    <b class="flex-1">Digital Signage (personalisierte Monitorwerbung in Ihrem Laden)</b>
                    <ScaleInput name="s19" :options="booleanOptions" v-model="form.serviceDigitalSignageAcknowledgement"/>
                </div>
                <div class="flex v-center gap-1">
                    <b class="flex-1">Produktfotografie</b>
                    <ScaleInput name="s20" :options="booleanOptions" v-model="form.serviceProductPhotographyAcknowledgement"/>
                </div>
                <div class="flex v-center gap-1">
                    <b class="flex-1">Geschäftsausstattung (Visitenkarte, Briefpapier, Blöcke, Kugelschreiber...)</b>
                    <ScaleInput name="s21" :options="booleanOptions" v-model="form.serviceBusinessStationaryAcknowledgement"/>
                </div>
                <div class="flex v-center gap-1">
                    <b class="flex-1">Werbetechnik (Beschilderung, Beklebung von Fahrzeugen und Schaufenstern...)</b>
                    <ScaleInput name="s22" :options="booleanOptions" v-model="form.serviceAdvertisingAcknowledgement"/>
                </div>
            ...
            <div class="group">
                <h5>Qualität</h5>
                <ScaleInput name="s23" :options="comparisonOptions" v-model="form.competitorQualitySentiment"/>
                <h5>Preis-Leistung</h5>
                <ScaleInput name="s24" :options="comparisonOptions" v-model="form.competitorPriceSentiment"/>
                <h5>Problemlösung</h5>
                <ScaleInput name="s25" :options="comparisonOptions" v-model="form.competitorProblemSolvingSentiment"/>
                <h5>Gesamteindruck</h5>
                <ScaleInput name="s26" :options="comparisonOptions" v-model="form.competitorOverallSentiment"/>
            </div>
            <p>&nbsp;</p>
    
            <h4>Wie wahrscheinlich ist es, dass Sie uns als Werbepartner weiterempfehlen?</h4>
            <div class="group">
                <ScaleInput name="s27" :show-label="false" :options="recommendOptions" v-model="form.wouldRecommend"/>
            </div>
            <p>&nbsp;</p>
            ...
            <div class="group">
                <mui-toggle type="checkbox" class="checkbox">
                    <template #label>
...
<script setup>
    ...
    const booleanOptions = [
        { color: '#249b5c', label: 'Ja', value: true },
        { color: '#EF434D', label: 'Nein', value: false },
    ]
