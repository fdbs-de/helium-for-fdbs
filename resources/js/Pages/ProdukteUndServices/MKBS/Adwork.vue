<template>
    <TextSubLayout image="/images/content/mkbs/banner/header_verpackungen.png" large-hero has-small-limiter>
        ...
        <p>
            Die für Ihre Marketing-Kampagnen entstandenen Designs lassen sich nicht nur in Print- und Digitalwerbung wieder
            aufgreifen und neu kombinieren, sondern mit unserer Hilfe auch auf Ihre Produktverpackungen anpassen. Neben klassischen
            Printartikeln bieten wir auch Verpackungsmaterial und Werbemittel, individuell nach Ihren Vorstellungen und in ihrem
            Layout an.
        </p>
