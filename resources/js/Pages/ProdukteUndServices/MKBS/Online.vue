<template>
    <TextSubLayout image="/images/content/mkbs/banner/header_onlinemarketing.png" large-hero has-small-limiter>
        <Head>
            <title>Online Marketing</title>
        </Head>

        <h1>Unsere Leistungen im Online Marketing</h1>
        <p>
            Ohne mobile Endgeräte ist unser Alltag inzwischen kaum mehr vorstellbar. Und damit einher geht die Relevanz von
            Marketing im Internet, in Suchmaschinen, den sozialen Medien und Blogs. Anzeigen, etwa über Google Ads machen
            potenzielle Kunden auf Ihr Unternehmen aufmerksam, Retargeting sorgt mit wiederkehrenden Anzeigen dafür, dass Sie ihnen
