<template>
    <TextSubLayout image="/images/content/mkbs/banner/header_cossmedia_292968998.png" large-hero>
        ...
        <div class="keyfacts">
            ...
            <div class="fact-card">
                <div class="icon font-icon">home_repair_service</div>
                <h3>Planung und Montage</h3>
            </div>
            <div class="fact-card">
                <div class="icon font-icon">cast</div>
                <h3>Digital Signage</h3>
            </div>
            <div class="fact-card">
                <div class="icon font-icon">tv</div>
                <h3>Addressable TV</h3>
            </div>
            <div class="fact-card">
                <div class="icon font-icon">videocam</div>
                <h3>Foto- und Videodreh</h3>
            </div>
            <div class="fact-card">
                <div class="icon font-icon">campaign</div>
            ...
            <div class="fact-card">
                <div class="icon font-icon">handshake</div>
                <h3>Recruiting</h3>
            </div>
        </div>
...
<style lang="sass" scoped>
    .keyfacts
        ...
        --color-local-primary-shade: #20bf6b30
