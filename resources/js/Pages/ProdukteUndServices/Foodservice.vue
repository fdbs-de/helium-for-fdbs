<template>
    <ServiceSubLayout title="Unser Foodservice" image="/images/content/test_banner.jpg">
        <Head>
            <title>Produkte & Services: Foodservice</title>
        </Head>

        <template #ansprechpartner>
            <StaffCard class="service-scroll-item" name="Madlen Krause" job="Leitung" link="tel:0531 210 55 18" label="0531 210 55 18" image="/images/content/mitarbeiter/missing.png" alt="Portrait von Madlen Krause"/>
