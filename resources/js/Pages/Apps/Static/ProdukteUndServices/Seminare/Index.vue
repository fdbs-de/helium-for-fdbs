<template>
    <TextSubLayout title="Unsere Seminare" image="/images/content/banner/seminare_291711336_335532188.webp" has-small-limiter>
        <Head>
        ...
        <div class="grid">
            ...
            <!-- <Card aspect-ratio="16/9" cover name="Aktivworkshop „Käse affinieren und veredeln“" alt="Aktivworkshop „Käse affinieren und veredeln“" primary-tag="05.06.2023" :tags="['Elke Grigat']" image="/images/content/seminare/kaeseworkshop/kaeseworkshop_card_223302273.webp" :link="route('seminare.kaeseworkshop')"/> -->
            ...
            <Card aspect-ratio="16/9" cover name="Employer Branding – Wie werde ich als Arbeitgeber sichtbar?" alt="Employer Branding – Wie werde ich als Arbeitgeber sichtbar?" primary-tag="10.07.2023" :tags="['Maja Kirsch', 'Benjamin Vahle']" image="/images/content/seminare/employer-branding/employer_branding_card_563275363.webp" :link="route('seminare.employer-branding')"/>
        </div>
        <!-- <Alert icon="info" title="Keine Seminare oder Workshops">
            <span>
                Zur Zeit sind keine Seminare oder Workshops geplant.<br>
                Kommen Sie ein anderes mal vorbei.<br>
                <br>
